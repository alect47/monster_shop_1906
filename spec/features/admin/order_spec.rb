...
describe 'Admin can see all orders' do
  before :each do
    ...
    @order_4 = @user_1.orders.create!(name: 'alec', address: '234 Main', city: 'Denver', state: 'CO', zip: 80_204, status: 2)
    @order_1 = @user_1.orders.create!(name: 'alec', address: '234 Main', city: 'Denver', state: 'CO', zip: 80_204, status: 0)
